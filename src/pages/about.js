      ...
      <div className="flex flex-column flex-row-ns">
        ...
        <div className="w-100 w-60-ns pl3-ns">
          <p className="f5 lh-copy tj">
            ...
            <a className="link" href="https://kapitaalutrecht.nl/"> Kapitaal</a>. They became captivated by the technique
            of screen-printing and immediately agreed to go printing again, this time on t-shirts. The thrill of creating
            their own clothing convinced them to spend more time understanding how clothes are made. Since then they have 
