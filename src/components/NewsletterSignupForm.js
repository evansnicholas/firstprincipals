...
export default () => (
    <div className="avenir br2-ns bb bt b--black-10 pa4 pv4-ns ph0-ns">
        <form className="mw7 center pb4">
            <fieldset className="cf bn ma0 pa0">
                <legend className="pa0 f6 fw6 mb2 black-80">Sign up to stay in touch:</legend>
                <div className="cf">
                    <label className="clip" for="email-address">Email Address</label>
                    <input className="f6 f5-l input-reset ba b--black-20 fl black-80 bg-white pa3 lh-solid w-100 w-75-m w-80-l br2-ns br--left-ns" placeholder="Your Email Address" type="text" name="email-address" value="" id="email-address" />
                    <input className="f6 f5-l button-reset fl pv3 tc bn bg-animate bg-black hover-bg-black white pointer w-100 w-25-m w-20-l br2-ns br--right-ns" type="submit" value="Subscribe" />
                </div>
            </fieldset>
        </form>
